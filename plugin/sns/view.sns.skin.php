...
<ul id="bo_v_sns" class="<?php echo $bo_v_sns_class; ?>">
	...
	?>
    <li><a href="javascript:kakaolink_send('<?php echo str_replace(array('%27', '\''), '', $sns_txt); ?>', '<?php echo $sns_url; ?>','<?php echo $kakaothumb['src'];?>', '300', '<?php echo $kakaothumb['height'];?>');"><img src="<?php echo G5_IMG_URL; ?>/sns/kakaotalk.png" alt="카카오톡으로 보내기"></a></li>
    <?php } ?>
