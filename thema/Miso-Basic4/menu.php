...
<script>
    ...
    $(document).ready(function(){
        ...
        var cur_menu = '<?php echo $bo_table; ?>'
        menu_array = ['sauna','incruit','skin','hair','shop_sell','ad_qna','notice'];        
        
        $('.menu-li').each(function(index, value){
            console.log(cur_menu+'-'+menu_array[index]);
            if(cur_menu == menu_array[index-1]){
                $(this).addClass('on');
            }
        });
    });
