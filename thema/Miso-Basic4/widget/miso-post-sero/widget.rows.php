...
$is_bh = '';
if($wset['bh']) {
	$is_bh_hidden = ($wset['fix']) ? '' : ' hidden-bh';
	$is_bh = '<div class="clearfix'.$is_bh_hidden.'" style="height:'.$wset['bh'].'px;"></div>'.PHP_EOL;
}

?>
<div class="media miso-post-sero<?php echo ($wset['fix']) ? '' : ' is-fix';?>">
	<div class="post-align pull-<?php echo ($wset['right']) ? 'right' : 'left';?>" style="width:<?php echo (isset($wset['size']) && $wset['size'] > 0) ? $wset['size'] : 125;?>px;">
