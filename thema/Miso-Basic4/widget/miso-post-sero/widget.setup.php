...
<div class="tbl_head01 tbl_wrap">
	...
	<tr>
		...
		<td>
			<?php echo help('0줄 입력시 제목과 댓글만 1줄로 출력됩니다.');?>
			...
			- 하단간격
			<input type="text" name="wset[bh]" value="<?php echo $wset['bh']; ?>" class="frm_input" size="3"> px
		</td>
	</tr>
	<tr>
		<td>
			...
			<label><input type="checkbox" name="wset[right]" value="1"<?php echo get_checked('1', $wset['right']);?>> 우측 이미지</label>
		</td>
	</tr>
	<tr>
