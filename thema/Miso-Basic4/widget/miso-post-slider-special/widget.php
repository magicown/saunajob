...
<style>
	...
	#<?php echo $widget_id;?> .item-list { margin-right:<?php echo $gap;?>px; border:#4E5EB6 solid 3px; padding:3px 3px; border-radius:5px; box-shadow:1px 4px 4px #eee; }
