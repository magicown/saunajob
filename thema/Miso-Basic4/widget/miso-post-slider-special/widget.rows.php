							...
							<?php if($wset['line_height']) { ?>
								<div class="post-content<?php echo $is_center;?>">
									<div class="post-subject">
										<a href="<?php echo $list[$i]['href'];?>"<?php echo $is_modal_js;?><?php echo $target;?>>
											<?php echo $wr_icon;?>
											<span style="font-size:1.2em;"><?php echo $list[$i]['subject'];?>
											<?php if($is_cont) { ?>
												<div class="post-text">
													<b style="color:#4e5eb7;"><?php echo $list[$i]['wr_4']." / ".$list[$i]['wr_6']." / ".$list[$i]['wr_7'];?></b>
												</div>												
                                            <?php } ?>
                                            <b style="font-size:0.8em;"><?php echo $list[$i]['wr_2'];?></b>
										</a>
									</div>
