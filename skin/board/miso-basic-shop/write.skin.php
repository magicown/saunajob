...
<div id="bo_w" class="write-wrap box-colorset<?php echo (G5_IS_MOBILE) ? ' box-colorset-mobile' : '';?>">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label hidden-xs" for="ca_name">설립일<strong class="sound_only">필수</strong></label>
        <div class="col-sm-3">
            <input type="text" name="wr_2" id="wr_2" value="<?php echo $wr_2 ?>" class="form-control input-sm" >
        </div> 
        <label class="col-sm-2 control-label hidden-xs" for="ca_name">업종<strong class="sound_only">필수</strong></label>
        <div class="col-sm-3">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label hidden-xs" for="ca_name">사원수<strong class="sound_only">필수</strong></label>
        <div class="col-sm-3">
            <input type="text" name="wr_4" id="wr_4" value="<?php echo $wr_4 ?>" class="form-control input-sm" >
        </div> 
        <label class="col-sm-2 control-label hidden-xs" for="ca_name">대출현황<strong class="sound_only">필수</strong></label>
        <div class="col-sm-3">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label hidden-xs" for="ca_name">운영여부<strong class="sound_only">필수</strong></label>
        <div class="col-sm-3">
            <input type="text" name="wr_6" id="wr_6" value="<?php echo $wr_6 ?>" class="form-control input-sm" >
        </div> 
        <label class="col-sm-2 control-label hidden-xs" for="ca_name">평수(층수)<strong class="sound_only">필수</strong></label>
        <div class="col-sm-3">
    ...
    <div class="form-group">
        ...
        <label class="col-sm-2 control-label hidden-xs" for="ca_name">거래구분<strong class="sound_only">필수</strong></label>
        <div class="col-sm-3">
