...
<div class="view-wrap view-colorset<?php echo (G5_IS_MOBILE) ? ' view-wrap-mobile view-colorset-mobile' : '';?>">
	<h1 style="text-align:center; border-top:#000000 solid 2px; border-bottom:#000000 solid 2px; padding-top:10px; margin-bottom:10px;">
				...
				<tr>
					...
					<?php
						...
						if($v_img_count && $is_img_head) {							
							for ($i=0; $i<=count($view['file']); $i++) {
								if ($view['file'][$i]['view']) {
									$summery_img = $view['file'][$i]['view'];
								}
							}							
						}
					?>
					<div class="view-img" style="line-height:200px;"><img src='<?php echo $view['file'][0]['path']."/".$view['file'][0]['file']; ?>' style="height:200px; margin-bottom:0px !important;" ></div>
					</th>
