...
<div id="bo_w" class="write-wrap box-colorset<?php echo (G5_IS_MOBILE) ? ' box-colorset-mobile' : '';?>">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label hidden-xs" for="ca_name">광고일자<strong class="sound_only">필수</strong></label>
        <div class="col-sm-4">
            <input type="text" name="wr_12" id="wr_12" value="<?php echo $wr_12; ?>" style="width:90px;"> ~ <input type="text" name="wr_13" id="wr_13" value="<?php echo $wr_13; ?>" style="width:90px;">
        </div>                     
    </div>

    <div class="form-group">        
        <label class="col-sm-2 control-label hidden-xs" for="ca_name">광고구분<strong class="sound_only">필수</strong></label>
        <div class="col-sm-6">
            <input type="checkbox" value="1" name="ad_type_s" <?php echo ($ad_type_s == '1')?'checked':''; ?>> 스페셜
            <input type="checkbox" value="1" name="ad_type_p" <?php echo ($ad_type_p == '1')?'checked':''; ?>> 프리미엄            
        </div>              
    </div>
    ...
    <div class="form-group">        
        <label class="col-sm-2 control-label hidden-xs" for="ca_name">지역<strong class="sound_only">필수</strong></label>
        <div class="col-sm-3">
            <select name="wr_1" id="wr_1" required class="form-control input-sm">
                <option value="">지역선택</option>
                <?php
                    foreach ($incruit_area as $key => $value) {
                ?>
                    <option value="<?php echo $value; ?>" <?php echo ($wr_1==$value)?'selected':''; ?> ><?php echo $value; ?></option>
                <?
                    }
                ?>
            </select>
        </div>
        <label class="col-sm-2 control-label hidden-xs" for="ca_name">상태<strong class="sound_only">필수</strong></label>
        <div class="col-sm-3">
            <select name="wr_11" id="wr_11" required class="form-control input-sm">
                <option value="">광고진행여부</option>               
                <option value="y" <?php echo ($wr_11 == 'y')?'selected':''; ?>>광고시작</option>
                <option value="n" <?php echo ($wr_11 == 'n')?'selected':''; ?>>광고중지</option>                
            </select>
        </div>        
    </div>

    <div class="form-group">
        <label class="col-sm-2 control-label hidden-xs" for="ca_name">업소명<strong class="sound_only">필수</strong></label>
        <div class="col-sm-3">
            <input type="text" name="wr_2" id="wr_2" value="<?php echo $wr_2 ?>" class="form-control input-sm" >
        </div> 
        <label class="col-sm-2 control-label hidden-xs" for="ca_name">연락처<strong class="sound_only">필수</strong></label>
        <div class="col-sm-3">
            <input type="text" name="wr_3" id="wr_3" value="<?php echo $wr_3 ?>" class="form-control input-sm" >
        </div>       
    </div>

    <div class="form-group">
        <label class="col-sm-2 control-label hidden-xs" for="ca_name">모집업종<strong class="sound_only">필수</strong></label>
        <div class="col-sm-3">
            <input type="text" name="wr_4" id="wr_4" value="<?php echo $wr_4 ?>" class="form-control input-sm" >
        </div> 
        <label class="col-sm-2 control-label hidden-xs" for="ca_name">추가연락처<strong class="sound_only">필수</strong></label>
        <div class="col-sm-3">
            <input type="text" name="wr_5" id="wr_5" value="<?php echo $wr_5 ?>" class="form-control input-sm" >
        </div>       
    </div>

    <div class="form-group">
        <label class="col-sm-2 control-label hidden-xs" for="ca_name">경력<strong class="sound_only">필수</strong></label>
        <div class="col-sm-3">
            <input type="text" name="wr_6" id="wr_6" value="<?php echo $wr_6 ?>" class="form-control input-sm" >
        </div> 
        <label class="col-sm-2 control-label hidden-xs" for="ca_name">급여조건<strong class="sound_only">필수</strong></label>
        <div class="col-sm-3">
            <input type="text" name="wr_7" id="wr_7" value="<?php echo $wr_7 ?>" class="form-control input-sm" >
        </div>       
    </div>

    <div class="form-group">
        <label class="col-sm-2 control-label hidden-xs" for="ca_name">고용형태<strong class="sound_only">필수</strong></label>
        <div class="col-sm-3">
            <input type="text" name="wr_8" id="wr_8" value="<?php echo $wr_8 ?>" class="form-control input-sm" >
        </div> 
        <label class="col-sm-2 control-label hidden-xs" for="ca_name">모집인원<strong class="sound_only">필수</strong></label>
        <div class="col-sm-3">
            <input type="text" name="wr_9" id="wr_9" value="<?php echo $wr_9 ?>" class="form-control input-sm" >
        </div>       
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label hidden-xs" for="ca_name">주소<strong class="sound_only">필수</strong></label>
        <div class="col-sm-8">
            <input type="text" name="wr_10" id="wr_10" value="<?php echo $wr_10 ?>" class="form-control input-sm" >
        </div>               
    </div>
	...
	<?php for ($i=0; $is_file && $i<$file_count; $i++) { ?>
		<div class="form-group">
			<label class="col-sm-2 control-label"><?php if($i==0) { echo '메인 배너'; } else { echo '상세정보'; } ?></label>
			<div class="col-sm-6">
	...
	<?php if($is_file) { ?>
		<div class="form-group" style="display:none;">
			...
			<div class="col-sm-10">
				...
				<label class="control-label sp-label">
					<input type="radio" name="as_img" value="1" checked> 하단출력
				</label>
				<label class="control-label sp-label">
