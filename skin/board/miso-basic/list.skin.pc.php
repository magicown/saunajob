...
<style>
    th, td {
		display: table-cell; vertical-align: inherit !important;
	}
</style>
<div class="table-responsive">
	...
	<?php for ($i=0; $i<count($list); $i++) { 
			...
			if ($wr_id == $list[$i]['wr_id']) {
				...
				$tr_css = $subject_css = '';
				$num = '<span class="en" style="">'.$list[$i]['num'].'</span>';
			}		
	...
	<tr<?php echo $tr_css; ?>>
		...
		<?php } ?>
		<?php if ($boset['num']) { ?>
			<td class="text-center font-11" style="display: table-cell; vertical-align: inherit;">
				<?php echo $num;?>
			</td>
		<?php } ?>
		<?php if ($boset['category']) { ?>
		...
		<?php } ?>
		<td style="color:#223390; display: table-cell; vertical-align: inherit;"><b><?php echo $list[$i]['wr_1']; ?></b></td>
		<td class="list-subject<?php echo $subject_css;?>">
			<a href="<?php echo $list[$i]['href'] ?>">
				<?php echo $list[$i]['icon_reply']; ?>
				<b style="color:#ffb808;"><?php echo $list[$i]['wr_2'] ?></b><br>
