					...
					<form name="fsearch" method="get" role="form" class="form" style="margin-top:20px;">
						...
						<div class="form-group">
							...
							<select name="sfl" id="sfl" class="form-control input-sm">
								<option value="wr_subject||wr_content||wr_1||wr_2"<?php echo get_selected($sfl, 'wr_subject||wr_content||wr_1||wr_2', true); ?>>전체검색</option>
								<option value="wr_subject"<?php echo get_selected($sfl, 'wr_subject', true); ?>>제목</option>
								<option value="wr_content"<?php echo get_selected($sfl, 'wr_content'); ?>>내용</option>
								<option value="wr_subject||wr_content"<?php echo get_selected($sfl, 'wr_subject||wr_content'); ?>>제목+내용</option>
								<option value="wr_1"<?php echo get_selected($sfl, 'wr_1'); ?>>지역</option>
								<option value="wr_2"<?php echo get_selected($sfl, 'wr_2'); ?>>상점명</option>								
							</select>
						</div>
						<div class="form-group">
